        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
              <div>
                <div style="float: left; margin-right: 10px;">Download data pembimbing</div>
                  <a href="<?php echo base_url(); ?>kaprodi/todoc"><button style="border-radius: 8px; border-color: -o-linear-gradient(top, #5bc0de 0%, #2aabd2 100%); border-color: -webkit-linear-gradient(top, #5bc0de 0%, #2aabd2 100%); border-style: solid; width: 70px; height: 20px; font-size: 10px;" type="button" class="btn-info">Download</button></a>
              </div>
              <br>
                <table id="example2" class="table table-bordered table-hover">
                 <thead>
                  <tr style="text-align: center;">
                    ...
                    <th width="200px">Judul Skripsi</th>
                    <th>Bidang Studi</th>
                    <th>Pembimbing</th>
                  </tr>
                  </thead>
