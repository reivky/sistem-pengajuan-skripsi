      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo base_url(); ?>kaprodi" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>kaprodi">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <?php endif; ?>
              <form action="<?php echo base_url(); ?>kaprodi/ubah" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="current_password">Password Lama</label>
                    <input type="password" name="old_pass" value="<?= set_value('old_pass') ?>" class="form-control" id="current_password" placeholder="Masukkan password lama" required="">
                    <?= form_error('current_password','<small class="text-danger pl-3">','</small>') ?>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password Baru</label>
                    <input type="password" name="new_pass" value="<?= set_value('new_pass') ?>" class="form-control" id="new_password1" placeholder="Masukkan password baru" required="">
                    <?= form_error('new_password1','<small class="text-danger pl-3">','</small>') ?>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Konfirmasi Password</label>
                    <input type="password" name="rep_new_pass" value="<?= set_value('rep_new_pass') ?>" class="form-control" id="new_password2" placeholder="Ulangi password baru" required="">
                    <?= form_error('rep_new_pass','<div class="alert alert-danger alert-dismissible" role="alert">
