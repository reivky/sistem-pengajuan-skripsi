  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Fakultas Teknik dan Informatika</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div style="width: 100px;">
                  <button type="button" class="btn btn-block btn-primary" data-toggle="modal" name="fakultas" value="Fakultas Teknik dan Informatika" data-target="#modal-tambah">Tambah</button>
                </div>
                <table id="fakultas1" class="table table-bordered table-hover">
                  <thead>
                  ...
                  <tr>
                    ...
                    <td class="hidetext"><?php echo $v->password ?></td>
                    <td>
                      <a onclick="deleteConfirm('<?php echo base_url('admin/hapus_dosen/'.$v->nidn) ?>')" href="#!" class="btn btn-block btn-danger"><i class="fas fa-trash-alt"></i> </a>
                      </button>
                    </td>
                  </tr>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Fakultas Ilmu Pendidikan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div style="width: 100px;">
                ...
                <table id="fakultas2" class="table table-bordered table-hover">
                  <thead>
                  <tr style="text-align: center;">
                    <th>NIDN</th>
                    <th>Nama</th>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Fakultas Hukum</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div style="width: 100px;">
                ...
                <table id="fakultas3" class="table table-bordered table-hover">
                  <thead>
                  <tr style="text-align: center;">
                    <th>NIDN</th>
                    <th>Nama</th>
    ...
    <!-- Modal Hapus -->
      ...
                                      </select>
                                    ...
                                    <div class="form-group">
                                      <label for="exampleInputUsername1">Bidang Studi</label>
                                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Bidang Studi" name="bidang" value="" required="">
                                    </div>
                                    <div class="form-group">
